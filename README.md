...
Whether a mobile money customer is eligible for a loan.
The loan amount or loan limit the customer may qualify for.
The customer risk group using unsupervised clustering.
